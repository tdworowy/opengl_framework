...
class AdditiveBlendEffect(BaseEffect):
    ...
    def __init__(self, blend_texture: Texture=None, original_strength=1,blend_strength=1):
        vertex_shader_code = """
        ...
        self.add_uniform(DataType.sampler2D, "blendTextureSampler", [blend_texture.texture_ref, 1])
